        ...
        return (
            <View style={{ flex: 1 }}>
                <ScrollView>
                    ...
                    <Text style={{ fontsize: 22, fontWeight: 'bold', marginLeft: '5%' }}>Login</Text>
                    ...
                    <View style={{ flexDirection: 'row', width: '90%', alignSelf: 'center', marginTop: 30, justifyContent: 'centers9o0', alignItems: 'center' }}>
